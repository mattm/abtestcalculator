define( [ 'lodash', './graph-renderer', './normal-difference-distribution', './range', './utils' ], function(_, GraphRenderer, NormalDifferenceDistribution, Range, Utils ) {
	...
	return ImprovementGraphRenderer;
} );
